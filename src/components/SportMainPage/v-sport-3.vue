          ...
          >
            <div class="card shadow-sm" >
              ...
              >
               ...
               <img class="bd-placeholder-img card-img-top" 
               v-else src="https://i0.wp.com/oecd-development-matters.org/wp-content/uploads/2023/04/africa-sport-investment-development-matters.jpg?fit=1200%2C502&ssl=1">
...
</svg> {{ formatDateTime(item.publishedAt) }}</small></span></p>
