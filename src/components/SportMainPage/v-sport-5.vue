<template lang="">
        ...
        :key="item">
                <div class="col-md-4 mb-4">
                 ...
                 >
                   ...
                   <img v-else src="https://i0.wp.com/oecd-development-matters.org/wp-content/uploads/2023/04/africa-sport-investment-development-matters.jpg?fit=1200%2C502&ssl=1"  class="img-fluid">
                    <a href="#!">
  ...
  </svg>                    <span style="font-size:8px">{{item.author}}</span></strong></u><br/>
            ...
            <section class="sticky-top" style="top: 80px;">
              ...
              <section class="text-center border-bottom pb-4 mb-4">
                <div class="bg-image hover-overlay ripple mb-4">
                  <br/><br/>
                  <img
                    src="https://greatpeopleinside.com/no/wp-content/uploads/2017/05/HR-GR8-technology.jpg"
                    class="img-fluid" />
