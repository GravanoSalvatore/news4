     ...
     :key="item"
      >
        ...
        <div class="col-md-8">
          ...
          focusable="false">
          <img v-else src="https://i0.wp.com/oecd-development-matters.org/wp-content/uploads/2023/04/africa-sport-investment-development-matters.jpg?fit=1200%2C502&ssl=1" class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="800" 
          height="500" 
