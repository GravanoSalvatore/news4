...
<img src="../assets/человек-в-пиджаке-кликает-на-виртуальный-экран-надпись-forex-trading-224134017.webp" class="baner-img">
...
.next-bt,.prev-bt{
    ...
    border: 2px solid  rgb(8, 242, 109);
    border-radius: 2px;
    padding: 7px;
    font-weight: bold;
    background-image: linear-gradient(to right,#040d1d, #053684);
