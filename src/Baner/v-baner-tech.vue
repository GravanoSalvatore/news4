<template lang="">
    <!-- <div> -->
        <div class="baner">
            <img src="../assets/technology-development.jpg"  class="baner-img">


<!-- <img   class="baner-img"> -->
<router-link class="router-link" to="/Tech"><button class="businessH">Technology</button></router-link>
...
<script>
import search from '../views/Select-4.vue'
export default {
  components:{search},
    data() {
    return {
