...
<img src="../assets/Cinema-Background-Music.jpg" class="baner-img">
...
<div class="container-content">
 ...
 <img  class="img" v-else src="../assets/enter.jpeg">
 ...
 <!-- <h3>Science</h3> -->
 <router-link class="router-link" to="/Entertainment"><button class="businessH">Entertainment</button></router-link>
